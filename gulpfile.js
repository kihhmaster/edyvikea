...
gulp.task('scripts', function() {
	return gulp.src([
		...
		'app/libs/jquery.cloud9carousel/jquery.cloud9carousel.min.js',
		'app/libs/magnificpopup/jquery.magnific-popup.min.js',
		'app/libs/jquery.fancybox/jquery.fancybox.min.js', // Always at the end
		'app/libs/jquery.mousewheel/jquery.mousewheel.min.js', // Always at the end
...
gulp.task('rsync', function() {
	...
	.pipe(rsync({
		root: 'app/',
		hostname: 'kihhmaster@edyvikea.ru',
		destination: 'edyvikea/public_html/',
